...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  final List<String> _titlesList = [
    ...
    'Pick the best Food'.tr(),
    'Get Fastest delivery'.tr(),
  ];
  ...
  final List<String> _subtitlesList = [
    ...
    'Fast delivery for whatever you desire! Pizza, burger, sushi, schnitzel, shawarma and…'.tr().tr(),
    'Get food delivered to your doorstep/business from the best local restaurants'.tr().tr(),
    'A qualitative leap in the world of delivery Best prices for meal delivery'.tr(),
  ];

  final List<dynamic> _imageList = [
    'assets/images/intro11.png',
    'assets/images/intro12.png',
    'assets/images/intro13.png',
  ];
