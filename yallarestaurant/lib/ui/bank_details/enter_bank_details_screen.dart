...
class _EnterBankDetailScreenState extends State<EnterBankDetailScreen> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                buildAccountNumberTextFiled(validator: validateOthers, title: "Account Number".tr(), controller: accountNoController),
  ...
  Widget buildAccountNumberTextFiled({required title, required String? Function(String?)? validator, required TextEditingController controller}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 16.0, horizontal: 25),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
