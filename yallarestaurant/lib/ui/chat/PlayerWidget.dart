  ...
  Widget _buildPlayBar() => Expanded(
        child: StreamBuilder<PlaybackDisposition>(
            ...
            builder: (context, snapshot) {
              ...
              return SliderTheme(
                data: SliderThemeData(trackShape: CustomTrackShape(), thumbShape: RoundSliderThumbShape(enabledThumbRadius: 5), thumbColor: widget.color, activeTrackColor: widget.color, inactiveTrackColor: Colors.grey.shade400, disabledThumbColor: widget.color),
                child: Slider(
                  onChanged: (value) {
