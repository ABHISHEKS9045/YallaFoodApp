...
import 'package:foodie_customer/ui/wallet/testforwallet.dart';
import 'package:foodie_customer/ui/wallet/walletTopupWebview.dart';
...
class WalletScreenState extends State<WalletScreen> {
  ...
  Future<void> navigateAndDisplaySelection(BuildContext context) async {
    final isWalletTopup = await Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => WallletTopUpScreen(
    ...
    if (isWalletTopup) {
      ...
      Future.delayed(Duration(seconds: 5), () {
        ...
        Fluttertoast.showToast(
            msg: 'Wallet amount added successfully!!'.tr(),
  ...
  //
  //     var request = BraintreePayPalRequest(amount: _amountController.text, currencyCode: currencyData!.code, billingAgreementDescription: "djsghxghf", displayName: 'Yalla company');
  ...
  bool isStaging = true;
  String callbackUrl =
      "http://162.241.125.167/~Yalla/payments/paytmpaymentcallback?ORDER_ID=";
