...
class _PlaceOrderScreenState extends State<PlaceOrderScreen> {
      ...
      child: Column(
        children: [
          ...
          ListTile(
            contentPadding: EdgeInsets.symmetric(horizontal: 40),
            title: Text(
              'com.yalla.customer.android, {}'.tr(args: ['${widget.orderModel.address.name}']),
              style: TextStyle(
  ...
  animateOut() {
    ...
    FireStoreUtils.sendFcmMessage("New Order".tr(), '${MyAppState.currentUser!.firstName}' + " has Ordered", widget.orderModel.vendor.fcmToken);
