...
class _SignUpState extends State<SignUpScreen> {
        ...
        Padding(
          ...
          child: Container(
            ...
            child: InternationalPhoneNumberInput(
              onInputChanged: (number) => mobile = number.phoneNumber,
              ignoreBlank: true,
              maxLength: 11,
  ...
  _signUpWithEmailAndPassword() async {
    ...
    dynamic result = await FireStoreUtils.firebaseSignUpWithEmailAndPassword(email!.trim(), password!.trim(), _image, firstName!, lastName!, mobile!, context);
    await hideProgress();
