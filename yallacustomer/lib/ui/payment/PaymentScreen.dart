...
import 'package:foodie_customer/ui/payment/paymenwebview.dart';
...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  bool isStaging = true;
  String callbackUrl = "http://162.241.125.167/~Yalla/payments/paytmpaymentcallback?ORDER_ID=";
  ...
  getPaymentSettingData() async {
    ...
    await UserPreference.getStripeData().then((value) async {
      ...
      stripe1.Stripe.merchantIdentifier = 'Yalla';
  ...
  void initState() {
    ...
    // old function for create order id on 19-04-2023 comment by nilesh
    // FireStoreUtils.createOrder();

    // new function for create order id on 19-04-2023 comment by nilesh
                ...
                CheckboxListTile(
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      paypal = false;
                      selectedCardID = '';
                      paymentOption = "Pay Online".tr() + "Credit Card";
                    });
                  },
                  value: uPay,
                  contentPadding: EdgeInsets.all(0),
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (razorPay) {
                ...
                /// commented by nilesh to build signed apk on 11-04-2023
                // paymentType = 'paypal';
                // showLoadingAlert();
  ...
  redirectPaymentPage(String paymentPageUrl) async {

    var url = Uri.parse(paymentPageUrl);
    // var url = Uri.parse("${BaseurlWeb}About");
  ...
  sendClearingIdAndToken( String clearingId, String loginToken) async {

    String sendingUrl = "https://yallafood.co.il/callbackUrl/1/2";
  ...
  String _currentUrl = '';
  // final String paymentUrl = 'https://example.com/payment'; // Replace with your payment URL
  String? paymentUrl;
  final String successUrl = 'https://yallafood.co.il/callbackUrl/1/2'; // Replace with your success URL
  ...
  void _handleUrlChanged(String url) {
    ...
    if (url == successUrl) {
      // Navigate back to the app with arguments
      ...
      //       argument: RouteArgument(param: 'Credit Card (Paytabs)'),
      //     ),
      //   ),
      // );
      // Navigator.of(context).pushReplacementNamed('/OrderSuccess',
      //     arguments: RouteArgument(param: 'Credit Card (Paytabs)'));
    }
  }
  ...
  //
  //     var request = BraintreePayPalRequest(amount: amount, currencyCode: currencyData!.code, billingAgreementDescription: "djsghxghf", displayName: 'Yalla company');
  //
  ...
  _flutterWaveInitiatePayment(
    ...
    final flutterwave = Flutterwave(
      ...
      customization: Customization(title: "Yalla App"),
      txRef: _ref!,
...
class RouteArgument {
  ...
  RouteArgument({required this.param});
}
