...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  String TAG = "_CheckoutScreenState";
  ...
  placeAutoOrder() {
    if (widget.isPaymentDone) {
      Future.delayed(Duration(milliseconds: 100), () {
        // TODO: need to change comment by nilesh to test some data 09-05-2023
       //debugPrint("$TAG sub total =====> ${widget.subTotal}");
       //debugPrint("$TAG discount total =======> ${widget.discountVal}");
       //debugPrint("$TAG special discount =======> ${widget.specialDiscountMap?["special_discount"]}");
        placeOrder();
      });
    }
  }
