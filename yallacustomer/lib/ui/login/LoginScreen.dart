...
class _LoginScreen extends State<LoginScreen> {
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Padding(
              padding: const EdgeInsets.only(left: 32.0, right: 32.0, top: 16, bottom: 16),
              child: Center(
                child: Text(
                  'or',
            ...
            Visibility(
              visible: false,
              child: Padding(
                padding: const EdgeInsets.only(right: 40.0, left: 40.0, bottom: 16),
                child: ConstrainedBox(
                  constraints: const BoxConstraints(minWidth: double.infinity),
  ...
  _loginWithEmailAndPassword(String email, String password) async {
    ...
    if (result != null && result is User && result.role == USER_ROLE_CUSTOMER) {
      ...
      await FireStoreUtils.updateCurrentUser(result).then((value) {
       ...
       //debugPrint(MyAppState.currentUser!.active.toString() + "===S");
  ...
  loginWithApple() async {
    try {
      ...
      await hideProgress();
     //debugPrint('_LoginScreen.loginWithApple $e $s');
