                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  widget.product.name,
                                  style: TextStyle(
                                    color: isDarkMode(context) ? const Color(0XFFFDFEFE) : const Color(0XFF000003),
                                    fontFamily: 'Poppinsm',
                                    fontSize: 20,
                                  ),
                                ),
                              ...
                              return Padding(
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: Text(
                                        reviewAttributeList[index].title.toString(),
                                      ),
                                    ),
                                    RatingBar.builder(
                                    ...
                                    SizedBox(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) => SizedBox(
                                          width: 150,
                                          child: _imageBuilder(_mediaFiles[index]),
                                        ),
                                        shrinkWrap: true,
                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(alignment: Alignment.center, child: Text(widget.product.name, style: TextStyle(color: isDarkMode(context) ? const Color(0XFFFDFEFE) : const Color(0XFF000003), fontFamily: 'Poppinsm', fontSize: 20))),
                              const SizedBox(
                                height: 15,
                              ),
                              RatingBar.builder(
          ...
          ? Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  var productModelResponse = await FireStoreUtils.updateProduct(productModel!);

                  if (errorMessage == null && productModelResponse != null) {
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text("your feedback submitted successfully"),
                    ));
                    await hideProgress();
