...
class _ViewAllPopularFoodNearByScreenState
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (vendors.isNotEmpty) {
                        //debugPrint("item name ${lstNearByFood[index].name}");
                        popularNearFoodVendorModel = null;
                        for (int a = 0; a < vendors.length; a++) {
                          //debugPrint(vendors[a].id.toString() + "===<><><><==" + lstNearByFood[index].vendorID);
  ...
  Widget buildVendorItemData(
    ...
    return GestureDetector(
      onTap: () {
        //debugPrint(popularNearFoodVendorModel.id.toString() + " *** " + popularNearFoodVendorModel.title.toString());
        push(
          context,
