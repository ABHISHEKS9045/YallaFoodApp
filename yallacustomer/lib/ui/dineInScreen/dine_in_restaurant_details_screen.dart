                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Menus", style: TextStyle(fontSize: 16, fontFamily: "Poppinsm")).tr(),
    ...
    if (widget.vendorModel.reststatus == true) {
      return Container(
          ...
          child: Row(children: [
            ...
            Text("Open", style: TextStyle(fontFamily: "Poppinssm", fontSize: 16, color: Color(0XFF3dae7d))).tr()
          ]));
    } else {
      return Container(
          height: 35,
          ...
          child: Row(children: [
            ...
            Text("Closed", style: TextStyle(fontFamily: "Poppinssm", fontSize: 16, letterSpacing: 0.5, color: Colors.redAccent)).tr()
          ]));
    }
  }
