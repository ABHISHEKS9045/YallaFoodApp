...
enum DrawerSelection { Home, Wallet, dineIn, Search, Cuisines, Cart, Profile, Orders, MyBooking, termsCondition, privacyPolicy, /*chooseLanguage,*/ inbox, driver, Logout, LikedRestaurant, LikedProduct, chooseLanguage }
...
class _ContainerScreen extends State<ContainerScreen> {
  ...
  void setListValue(String key, List<String> values) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setStringList(key, values);
    // print("SharedPreferences list set: $key - $values");
  }
  void setStringValue(String key,String value) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString(key, value);
    print("SharedPreferences set: $key - $value");
  ...
  setCurrency() async {
   //debugPrint("$TAG setCurrency =======> called");
      ...
      child: ChangeNotifierProvider.value(
        ...
        child: Consumer<User>(
          builder: (context, user, _) {
             setStringValue("customer_name",user.fullName().toString());
             setStringValue("customer_email",user.email.toString());
             setStringValue("customer_phone",user.phoneNumber.toString());
                            ...
                            children: [
                              ...
                              ListTileTheme(
                                ...
                                child: ListTile(
                                    ...
                                    title: Text(MyAppState.currentUser == null ? 'Login'.tr() : 'logOut'.tr()),
                                    onTap: () async {
                                      if (MyAppState.currentUser == null) {
