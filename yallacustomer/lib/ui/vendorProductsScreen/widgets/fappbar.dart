...
class FAppBar extends SliverAppBar {
  static const String TAG = "FAppBar";
  ...
  Widget? get flexibleSpace {
    return LayoutBuilder(
      builder: (
       ...
       //debugPrint("$TAG collapsedHeight ========> $collapsedHeight");
        ...
        return FlexibleSpaceBar(
          ...
          background: Column(
            children: [
              ...
              offerList.isEmpty
                  ? showEmptyState('Special Offer currently not available'.tr(), context)
                  : SizedBox(
                      height: 70,
                      child: Padding(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  FlutterClipboard.copy(offerList[index].offerCode!).then((value) {
                                    //debugPrint('copied'));
                                  });
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(
                                              "Closed".tr(),
                                              style: const TextStyle(fontFamily: "Poppinsm", color: Colors.redAccent),
                                            )
                                          ],
                                        ),
                                      ),
            ...
            child: Row(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontFamily: "Poppinsr",
                    color: isDarkMode(context) ? const Color(0XFFa5a292) : const Color(0xff5A5D6D),
                  ),
                ),
                //  SizedBox(height: 5,),
                Text(
                  timeslot.from.toString(),
                  style: TextStyle(
                    fontFamily: "Poppinsm",
                    color: isDarkMode(context) ? const Color(0XFFa5a292) : const Color(0XFF5A5D6D),
                  ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        "valid till ".tr() + getDate(offerList[index].expireOfferDate!.toDate().toString())!,
                        style: const TextStyle(
                          fontFamily: "Poppins",
                          letterSpacing: 0.5,
