...
class VendorModel {
  ...
  factory VendorModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return new VendorModel(
        ...
        description: parsedJson['${lang == "en" ? "description"  : "description_$lang"}'] ?? '',
        ...
        title: parsedJson['${lang == "en" ? "title"  : "title_$lang"}'] ?? '',
  ...
  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {
      ...
      '${lang == "en" ? "title"  : "title_$lang"}': this.description,
      ...
      '${lang == "en" ? "description"  : "description_$lang"}': this.title,
